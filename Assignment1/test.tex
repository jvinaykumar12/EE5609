...
\begin{align}
\text{d} = \frac{\lvert\text{c} - \textbf{n}^T\textbf{A}\rvert}{\norm{\vec{n}}}
\end{align}
By substituting the given values 
\begin{align}
\textbf{A} = \myvec{1 \\ -1} \hspace{0.5cm}  \textbf{n} = \myvec{12 \\ -5} \hspace{0.5cm}   \text{c} = -82
\end{align}

we get  
\begin{align}
 \lvert\text{c} - \textbf{n}^T\textbf{A}\rvert = 99
\end{align}
