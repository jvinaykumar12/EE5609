...
\begin{lstlisting}
https://github.com/jvinaykumar12/EE5609/tree/master/Assignment2
\end{lstlisting}
%
...
\end{align}\\
Thus, from the above row reduced form we can conclude that the given system of lines has no solution. Therefore, they are inconsistent.
